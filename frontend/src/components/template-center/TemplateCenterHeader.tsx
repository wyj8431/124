...
/** 对标官网 templatecenter 顶部搜索栏 */
export function TemplateCenterHeader({ keyword, onKeywordChange, onSearch }: Props) {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-[#eef0f3] bg-white">
      <div className="mx-auto flex h-[60px] max-w-[1400px] items-center gap-6 px-6">
